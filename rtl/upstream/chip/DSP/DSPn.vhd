...
begin
	...
	PROG_ROM : entity work.spram_sz generic map(13, 24, 8096, "rtl/upstream/chip/DSP/dsp11b23410_p.mif")
	port map(
		clock		=> CLK,
	...
	DATA_ROM : entity work.spram_sz generic map(13, 16, 7168, "rtl/upstream/chip/DSP/dsp11b23410_d.mif")
	port map(
		clock		=> CLK,
